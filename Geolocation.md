Uwazi supports geolocation of contents. When there are entities in the database whith geolocation properties, the map toggle button will appear in Uwazi's library:
